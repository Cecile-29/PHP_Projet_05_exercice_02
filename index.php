...
<body>
    <div class="container-fluid col-11 p-3 m-4 border border-warning rounded justify-content-center">
        <div class="row ">
            <h1 class="col-12 text-secondary text-center">PHP Projet05 Exercice02</h1>
        ...
        <div class="row border border-primary rounded p-3 m-4 text-secondary justify-content-center">
            <a href="index02.php?nom=Cécile&amp;prenom=Cécile&amp;age=41">cliquez pour être redirigé vers une page qui affiche les paramètres de l'url : </a>
        </div>
        <div class="row border border-primary rounded p-3 m-4 text-secondary justify-content-center">
            <?php 
